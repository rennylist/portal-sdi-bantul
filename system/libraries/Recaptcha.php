...
class CI_Recaptcha
{
    ...
    public function __construct()
    {
        ...
        $this->_ci->load->model('public/m_preferences');
        $site_key = $this->_ci->m_preferences->get_preferences_by_id(3);
        $secret_key = $this->_ci->m_preferences->get_preferences_by_id(4);
        $this->_siteKey = $site_key['pref_value'];
        $this->_secretKey = $secret_key['pref_value'];
        $this->_language = "id";
