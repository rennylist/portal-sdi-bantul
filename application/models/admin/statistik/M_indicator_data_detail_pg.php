...
class M_indicator_data_detail_pg extends CI_Model
{
    ...
    {
        return $this->db2->insert('trx_indicator_data_detail', $params);
    }

    // delete trx_slideshow
    function delete($params)
    {
        return $this->db2->delete('trx_indicator_data_detail', $params);
    }


    function update($params, $where)
    {
        return $this->db2->update('trx_indicator_data_detail', $params, $where);
    }
}
