...
class M_urusan extends CI_Model
{
    ...
    // get all urusan
    public function get_all_urusan()
    {
        $sql = "SELECT * FROM trx_urusan ORDER BY urusan_id ASC";
    ...
    public function get_total_urusan($params)
    {
        $sql = "SELECT COUNT(*) AS 'total' FROM trx_urusan";
